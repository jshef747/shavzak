...
const strings: Record<string, { en: string; he: string }> = {
  ...
  autoAssignReassignBody: { en: 'All cells are already filled. This will clear every existing assignment and reassign from scratch.', he: 'כל התאים כבר מאויישים. פעולה זו תמחק את כל השיבוצים הקיימים ותשבץ מחדש מהתחלה.' },
