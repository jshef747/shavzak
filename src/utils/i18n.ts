...
const strings: Record<string, { en: string; he: string }> = {
  ...
  deleteSchedule: { en: 'Delete board', he: 'מחק לוח' },
  ...
  onCallDuration: { en: "On-Call (h)", he: "כוננות (שע')" },
  ...
  statusOncallOverride:    { en: 'On-call (constraints ignored)', he: 'כוננות – אילוצים התעלמו' },
  tooltipOncallOverride:   { en: 'Assigned to on-call despite constraints (override mode active)', he: 'שובץ לכוננות בניגוד לאילוצים (מצב התעלמות פעיל)' },
  ignoreOnCallConstraintsLabel: { en: 'Ignore constraints for on-call positions', he: 'התעלם מאילוצים בתפקידי כוננות' },
  ignoreOnCallConstraintsDesc:  { en: 'When enabled, unavailability and shift constraints are bypassed for on-call positions (home group blocks are still respected). Overridden assignments are shown in green with a warning.', he: 'כאשר מופעל, חוסר זמינות ואילוצי משמרת מתעלמים עבור תפקידי כוננות (חסימות קבוצת בית עדיין מכובדות). שיבוצים שעקפו אילוצים יוצגו בירוק עם אזהרה.' },
  ...
  neverAutoAssignLabel: { en: 'Never Auto-Assign', he: 'לא לשבץ אוטומטית' },
  neverAutoAssignDesc: { en: 'This person will always be skipped by auto-assign.', he: 'אדם זה יידלג תמיד בשיבוץ האוטומטי.' },
