...
const strings: Record<string, { en: string; he: string }> = {
  ...
  assignGroupToEach: { en: 'Assign People to Groups', he: 'שיבוץ אנשים לקבוצות' },
  assignGroupToEachDesc: { en: 'Set a home group for each person using the dropdown', he: 'בחר קבוצת יציאה לכל אדם בעזרת התפריט' },
  assignGroupToSelected: { en: 'Assign Group', he: 'שבץ קבוצה' },
  assignGroupToSelectedDesc: { en: 'Assign the selected people to a home group', he: 'שבץ את האנשים הנבחרים לקבוצת יציאה' },
  ...
  tabPresets: { en: 'Presets', he: 'תבניות' },
  positionPresets: { en: 'Position Presets', he: 'תבניות תפקיד' },
  hourPresets: { en: 'Hour Presets', he: 'תבניות שעות' },
  addPreset: { en: 'Add Preset', he: 'הוסף תבנית' },
  presetNamePlaceholder: { en: 'Preset name', he: 'שם תבנית' },
  noPresets: { en: 'No presets yet. Add one below.', he: 'אין תבניות עדיין. הוסף אחת למטה.' },
  quickPresets: { en: 'Quick presets:', he: 'תבניות מהירות:' },
  positionPresetsDesc: { en: 'Save role names to quickly fill positions', he: 'שמור שמות תפקידים למילוי מהיר' },
  hourPresetsDesc: { en: 'Save named time blocks to quickly define shifts', he: 'שמור בלוקי זמן עם שמות להגדרת משמרות מהירה' },
  saveAsPreset: { en: 'Save as Preset', he: 'שמור כתבנית' },
  ...
  passwordLabel: { en: 'Password', he: 'סיסמה' },
  emailPlaceholder: { en: 'you@example.com', he: 'israel@example.com' },
  passwordPlaceholder: { en: '••••••••', he: '••••••••' },
  passwordRequirements: { en: 'Password must be at least 8 characters long, and include an uppercase letter, a lowercase letter, a number, and a special character.', he: 'הסיסמה חייבת להיות באורך של 8 תווים לפחות, ולכלול אות גדולה, אות קטנה, מספר ותו מיוחד.' },
  authFailed: { en: 'Authentication failed', he: 'האימות נכשל' },
  noAccountRegister: { en: "Don't have an account? Register", he: 'אין לך חשבון? הירשם' },
  haveAccountLogin: { en: 'Already have an account? Login', he: 'כבר יש לך חשבון? התחבר' },
  confirmPasswordLabel: { en: 'Confirm Password', he: 'אימות סיסמה' },
  passwordMismatch: { en: 'Passwords do not match', he: 'הסיסמאות אינן תואמות' },
  pwReq8Chars: { en: 'At least 8 characters', he: 'לפחות 8 תווים' },
  pwReqUppercase: { en: 'Uppercase letter', he: 'אות גדולה' },
  pwReqLowercase: { en: 'Lowercase letter', he: 'אות קטנה' },
  ...
  // --- Role / team system ---
  tabUsers:              { en: 'Users', he: 'משתמשים' },
  myProfile:             { en: 'My Profile', he: 'הפרופיל שלי' },
  inviteBanner:          { en: "You've been invited to join a schedule. Register or log in to continue.", he: 'הוזמנת להצטרף ללוח שיבוצים. הירשם או התחבר כדי להמשיך.' },
  inviteSetupTitle:      { en: 'Set Up Your Profile', he: 'הגדר את הפרופיל שלך' },
  inviteNameLabel:       { en: 'Your Name', he: 'שמך' },
  inviteNamePlaceholder: { en: 'Full name', he: 'שם מלא' },
  inviteRoleLabel:       { en: 'Your Role', he: 'התפקיד שלך' },
  inviteRolePlaceholder: { en: 'Select a position…', he: 'בחר תפקיד…' },
  inviteJoinBtn:         { en: 'Join Schedule', he: 'הצטרף ללוח' },
  inviteJoinError:       { en: 'Failed to join. The invite may be invalid or expired.', he: 'ההצטרפות נכשלה. ייתכן שהקישור אינו בתוקף.' },
  generateLink:          { en: 'Generate Invite Link', he: 'צור קישור הזמנה' },
  copyLink:              { en: 'Copy Link', he: 'העתק קישור' },
  linkCopied:            { en: 'Copied!', he: 'הועתק!' },
  revokeInvite:          { en: 'Revoke', he: 'בטל' },
  revokeInviteConfirm:   { en: 'Revoke this invite link? Anyone using it will no longer be able to join.', he: 'לבטל קישור ההזמנה הזה? מי שישתמש בו לא יוכל עוד להצטרף.' },
  activeInviteLink:      { en: 'Active invite link:', he: 'קישור הזמנה פעיל:' },
  noActiveInvite:        { en: 'No active invite link.', he: 'אין קישור הזמנה פעיל.' },
  membersSection:        { en: 'Team Members', he: 'חברי צוות' },
  noMembersLinked:       { en: 'No members linked yet.', he: 'עדיין לא קושרו חברים.' },
  memberRole:            { en: 'Role', he: 'תפקיד' },
  removeFromTeam:        { en: 'Remove', he: 'הסר' },
  removeFromTeamConfirm: { en: 'Remove this member from the team?', he: 'להסיר חבר זה מהצוות?' },
  makeAdmin:             { en: 'Make Admin', he: 'הפוך למנהל' },
  makeUser:              { en: 'Make User', he: 'הפוך למשתמש' },
  waitingForAdmin:       { en: 'Waiting for access', he: 'ממתין לגישה' },
  waitingForAdminDesc:   { en: "Your account is set up. Ask your admin to share the schedule's invite link.", he: 'חשבונך מוכן. בקש מהמנהל לשתף את קישור ההזמנה ללוח.' },
  swapRequests:          { en: 'Swap Requests', he: 'בקשות החלפה' },
  requestSwap:           { en: 'Request Swap', he: 'בקש החלפה' },
  incomingSwaps:         { en: 'Incoming', he: 'נכנסות' },
  outgoingSwaps:         { en: 'Outgoing', he: 'יוצאות' },
  approveSwap:           { en: 'Approve', he: 'אשר' },
  rejectSwap:            { en: 'Reject', he: 'דחה' },
  cancelSwap:            { en: 'Cancel Request', he: 'בטל בקשה' },
  swapConstraintWarning: { en: 'Warning: this swap may violate constraints', he: 'אזהרה: החלפה זו עלולה להפר אילוצים' },
  noIncomingSwaps:       { en: 'No incoming swap requests', he: 'אין בקשות החלפה נכנסות' },
  noOutgoingSwaps:       { en: 'No outgoing swap requests', he: 'אין בקשות החלפה יוצאות' },
  swapRequestTitle:      { en: 'Request a Swap', he: 'בקש החלפה' },
  swapYourCell:          { en: 'Your assignment', he: 'השיבוץ שלך' },
  swapTargetPerson:      { en: 'Swap with', he: 'החלף עם' },
  swapTargetCell:        { en: 'Their assignment', he: 'השיבוץ שלהם' },
  swapUnscheduled:       { en: 'Unscheduled (take your shift)', he: 'לא משובץ (יקבל את המשמרת שלך)' },
  swapSubmit:            { en: 'Send Request', he: 'שלח בקשה' },
  swapStatusPending:     { en: 'Pending', he: 'ממתין' },
  swapStatusApproved:    { en: 'Approved', he: 'אושר' },
  swapStatusRejected:    { en: 'Rejected', he: 'נדחה' },
  swapStatusCancelled:   { en: 'Cancelled', he: 'בוטל' },
  deleteBulk:            { en: 'Delete Selected', he: 'מחק נבחרים' },
};
