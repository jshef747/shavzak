...
export function Sidebar({ state, assignments, onEditPerson, onDeletePerson, open, onClose }: Props) {
  ...
  if (!isMobile) {
    return (
      <aside className="no-print flex flex-col w-56 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l border-gray-200">
  ...
  return (
    <>
      ...
      {/* Drawer panel */}
      <aside
        className={`no-print fixed inset-y-0 left-0 rtl:left-auto rtl:right-0 z-30 w-64 flex flex-col overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l border-gray-200 transition-transform duration-200 ease-out ${
      ...
      >
        <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 shrink-0">
          ...
          <button
            ...
            className="p-1 rounded text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors duration-150"
          >
